...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Di 26. Jun 10:12:38 2012
# Project:  pic.pro
# Template: app
# Command: c:\qtsdk\desktop\qt\4.8.1\mingw\bin\qmake.exe -spec c:\qtsdk\desktop\qt\4.8.1\mingw\mkspecs\win32-g++ CONFIG+=declarative_debug -o Makefile pic.pro
#############################################################################
...
Makefile: pic.pro  c:/qtsdk/desktop/qt/4.8.1/mingw/mkspecs/win32-g++/qmake.conf c:/QtSDK/Desktop/Qt/4.8.1/mingw/mkspecs/qconfig.pri \
	...
	$(QMAKE) -spec c:\qtsdk\desktop\qt\4.8.1\mingw\mkspecs\win32-g++ CONFIG+=declarative_debug -o Makefile pic.pro
